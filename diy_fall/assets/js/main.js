...
var _user$project$Main$initialModel = {phxSocket: _user$project$Main$initializeSocket, name: '', gameCode: ''};
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$initChannel = function (channel) {
	return _fbonetti$elm_phoenix_socket$Phoenix_Channel$init(
		A2(_elm_lang$core$Basics_ops['++'], 'games:', channel));
};
var _user$project$Main$joinChannel = F2(
	function (socket, gameCode) {
		return A2(
			_fbonetti$elm_phoenix_socket$Phoenix_Socket$join,
			_user$project$Main$initChannel(gameCode),
			socket);
	});
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {phxSocket: a, name: b, gameCode: c};
	});
var _user$project$Main$SetGameCode = function (a) {
	return {ctor: 'SetGameCode', _0: a};
};
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetName),
								_1: {
									ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetGameCode),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.gameCode),
										_1: {ctor: '[]'}
									}
								}
							},
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'ProcessSocketData':
				var d = A2(_elm_lang$core$Debug$log, 'data', _p0._0);
			...
			case 'JoinChannel':
				var _p2 = A2(_user$project$Main$joinChannel, model.phxSocket, model.gameCode);
				var phx = _p2._0;
				var msg = _p2._1;
				var d = A2(_elm_lang$core$Debug$log, 'phx', phx);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			default:
				var pmsg = A2(
					...
					A2(
						...
						_user$project$Main$ProcessSocketData,
						A2(_user$project$Main$push, 'show', model)));
				var d = A2(_elm_lang$core$Debug$log, 'pmsg', pmsg);
				var _p3 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, pmsg, model.phxSocket);
